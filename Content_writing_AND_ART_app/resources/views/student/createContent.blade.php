    ...
    <form method="POST" action="" enctype="multipart/form-data">
        <div class="flex flex-col items-start justify-center mt-6 sm:flex-row">
            ...
            <div class="mb-6 sm:mr-6 sm:mb-6">
                <label for="dropzone-file" class="relative flex flex-col items-center justify-center w-64 h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-600 dark:bg-gray-500 hover:bg-gray-50 dark:border-gray-400 dark:hover:border-gray-300 dark:hover:bg-gray-600">
            ...
            <div class="w-full px-6 py-4 bg-white shadow-md sm:max-w-md sm:rounded-lg">
                ...
                <div class="mt-4">
                    ...
                    <x-input class="block w-full mt-1 text-gray-700" id="title" type="text" name="title" :value="old('title')" required />
                </div>
                ...
                <div class="mt-4">
                    ...
                    <select id="category" class="block w-full mt-1 text-gray-700" name="category" required>
                ...
                <div class="mt-4">
                    ...
                    <x-input id="keywords" class="block w-full mt-1 text-gray-700" type="text" name="keywords" :value="old('keywords')" required title="Write keywords that best describes your content to improve search for your content" placeholder="Enter keywords separated by commas" />
                </div>

                <!-- Chapter-wise -->
                <div class="mt-4">
                    <label for="is_chapter" class="inline-flex items-center">
                        <input id="is_chapter" type="checkbox" name="is_chapter" title="Only check if your content will based on chapters" class="text-indigo-600 border-gray-300 rounded shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        <span class="ml-2 text-sm text-gray-600">{{ __('Chapter-wise') }}</span>
                    </label>
                </div>
