    ...
    <x-app-layout>
        <form method="POST" id="content-form" action="{{ route('student.updateContent', $content->ContentID) }}">
            ...
            <div class="flex items-center justify-between px-4 mx-auto mt-4 border-b border-gray-100 max-w-7xl">
                ...
                <div class="flex">
                    <button disabled type="button" class="inline-flex items-center text-sm font-medium text-green-800 bg-transparent bg-white border rounded-lg me-2 hover:bg-gray-100 hover:text-green-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-green-700 focus:text-green-700">
            ...
            <div class="flex flex-col items-center justify-center px-6 mt-6 mb-2">
