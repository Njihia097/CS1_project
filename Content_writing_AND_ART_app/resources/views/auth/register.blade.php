<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-label for="phone" value="{{ __('Phone_no') }}" />
                <x-input id="phone" class="block w-full mt-1" type="text" name="phone" :value="old('phone')" required autocomplete="username" />
            </div>
        ...
        <div>
            <h3 class="flex justify-center pt-2 pb-2 text-lg font-semibold">Or</h3>
        </div>
        <form class="flex justify-center" action="{{ route('google-auth') }}" method="GET">
